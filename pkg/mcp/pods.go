...
func (s *Server) initPods() []server.ServerTool {
	return []server.ServerTool{
		{Tool: mcp.NewTool("pods_list",
			mcp.WithDescription("List all pods across namespaces with their status and resource usage for application monitoring"),
		...
		{Tool: mcp.NewTool("pods_list_in_namespace",
			mcp.WithDescription("List pods within a specific namespace to focus on application components in that scope"),
			mcp.WithString("k8surl", mcp.Description("Kubernetes API server URL"), mcp.Required()),
			mcp.WithString("k8stoken", mcp.Description("Kubernetes API server authentication token"), mcp.Required()),
		...
		{Tool: mcp.NewTool("pods_get",
			mcp.WithDescription("Retrieve detailed pod information including configuration, events, and container status"),
			mcp.WithString("k8surl", mcp.Description("Kubernetes API server URL"), mcp.Required()),
			mcp.WithString("k8stoken", mcp.Description("Kubernetes API server authentication token"), mcp.Required()),
		...
		{Tool: mcp.NewTool("pods_delete",
			mcp.WithDescription("Delete specific pods to force recreation and apply configuration changes"),
			mcp.WithString("k8surl", mcp.Description("Kubernetes API server URL"), mcp.Required()),
			mcp.WithString("k8stoken", mcp.Description("Kubernetes API server authentication token"), mcp.Required()),
		...
		{Tool: mcp.NewTool("pods_exec",
			mcp.WithDescription("Execute commands inside running pods for real-time debugging and diagnostics"),
			mcp.WithString("k8surl", mcp.Description("Kubernetes API server URL"), mcp.Required()),
			mcp.WithString("k8stoken", mcp.Description("Kubernetes API server authentication token"), mcp.Required()),
			mcp.WithString("namespace", mcp.Description("Namespace to get the Pod from")),
		...
		{Tool: mcp.NewTool("pods_log",
			mcp.WithDescription("Retrieve container logs from pods to analyze application output and errors"),
			mcp.WithString("k8surl", mcp.Description("Kubernetes API server URL"), mcp.Required()),
			mcp.WithString("k8stoken", mcp.Description("Kubernetes API server authentication token"), mcp.Required()),
		...
		{Tool: mcp.NewTool("pods_run",
			mcp.WithDescription("Create and run new pods with specified container images for testing or temporary deployments"),
			mcp.WithString("k8surl", mcp.Description("Kubernetes API server URL"), mcp.Required()),
			mcp.WithString("k8stoken", mcp.Description("Kubernetes API server authentication token"), mcp.Required()),
