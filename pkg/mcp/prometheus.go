...
func (s *Server) initPrometheus() []server.ServerTool {
	return []server.ServerTool{
		...
		{Tool: mcp.NewTool("prometheus_metric_info",
			mcp.WithDescription("Retrieve metadata and statistics for specific metrics to understand data structure and availability"),
			mcp.WithString("k8surl", mcp.Description("Kubernetes API server URL"), mcp.Required()),
			mcp.WithString("k8stoken", mcp.Description("Kubernetes API server authentication token"), mcp.Required()),
		...
		{Tool: mcp.NewTool("prometheus_series_query",
			mcp.WithDescription("Discover time series data matching label selectors to identify available metric combinations"),
			mcp.WithString("k8surl", mcp.Description("Kubernetes API server URL"), mcp.Required()),
			mcp.WithString("k8stoken", mcp.Description("Kubernetes API server authentication token"), mcp.Required()),
		...
		{Tool: mcp.NewTool("prometheus_targets",
			mcp.WithDescription("Monitor scrape target health and configuration to ensure data collection reliability"),
			mcp.WithString("k8surl", mcp.Description("Kubernetes API server URL"), mcp.Required()),
			mcp.WithString("k8stoken", mcp.Description("Kubernetes API server authentication token"), mcp.Required()),
		...
		{Tool: mcp.NewTool("prometheus_targets_metadata",
			mcp.WithDescription("Access metric metadata from scrape targets to understand data types and descriptions"),
			mcp.WithString("k8surl", mcp.Description("Kubernetes API server URL"), mcp.Required()),
			mcp.WithString("k8stoken", mcp.Description("Kubernetes API server authentication token"), mcp.Required()),
		...
		{Tool: mcp.NewTool("prometheus_list_label_names",
			mcp.WithDescription("Discover available label names across metrics to understand data dimensionality and filtering options"),
			mcp.WithString("k8surl", mcp.Description("Kubernetes API server URL"), mcp.Required()),
			mcp.WithString("k8stoken", mcp.Description("Kubernetes API server authentication token"), mcp.Required()),
		...
		{Tool: mcp.NewTool("prometheus_list_label_values",
			mcp.WithDescription("Explore label value distributions to understand data cardinality and filtering capabilities"),
			mcp.WithString("k8surl", mcp.Description("Kubernetes API server URL"), mcp.Required()),
			mcp.WithString("k8stoken", mcp.Description("Kubernetes API server authentication token"), mcp.Required()),
		...
		{Tool: mcp.NewTool("prometheus_get_alerts",
			mcp.WithDescription("Retrieve all currently firing alerts in the Prometheus server to monitor current alert state and identify ongoing issues"),
			mcp.WithString("k8surl", mcp.Description("Kubernetes API server URL"), mcp.Required()),
			mcp.WithString("k8stoken", mcp.Description("Kubernetes API server authentication token"), mcp.Required()),
		), Handler: s.prometheusGetAlerts},
		{Tool: mcp.NewTool("prometheus_get_rules",
			mcp.WithDescription("Retrieve information about configured alerting and recording rules in Prometheus to understand what alerts are defined and what metrics are being pre-computed"),
			mcp.WithString("k8surl", mcp.Description("Kubernetes API server URL"), mcp.Required()),
			mcp.WithString("k8stoken", mcp.Description("Kubernetes API server authentication token"), mcp.Required()),
		...
		{Tool: mcp.NewTool("prometheus_create_alert",
			mcp.WithDescription("Define alerting rules that will trigger notifications when specific conditions are met to customize the alert with annotations, labels, and evaluation intervals"),
			mcp.WithString("k8surl", mcp.Description("Kubernetes API server URL"), mcp.Required()),
			mcp.WithString("k8stoken", mcp.Description("Kubernetes API server authentication token"), mcp.Required()),
		...
		{Tool: mcp.NewTool("prometheus_update_alert",
			mcp.WithDescription("Modify the properties of an existing alert without having to delete and recreate it to update the condition, annotations, labels, and other attributes"),
			mcp.WithString("k8surl", mcp.Description("Kubernetes API server URL"), mcp.Required()),
			mcp.WithString("k8stoken", mcp.Description("Kubernetes API server authentication token"), mcp.Required()),
		...
		{Tool: mcp.NewTool("prometheus_delete_alert",
			mcp.WithDescription("Remove an existing alert rule from the system to either delete a specific alert within a rule group or the entire PrometheusRule resource"),
			mcp.WithString("k8surl", mcp.Description("Kubernetes API server URL"), mcp.Required()),
			mcp.WithString("k8stoken", mcp.Description("Kubernetes API server authentication token"), mcp.Required()),
			mcp.WithString("applabel", mcp.Description("Application label that identifies the PrometheusRule resource, use alertname if applabel is not provided"), mcp.Required()),
			mcp.WithString("namespace", mcp.Description("Kubernetes namespace of the alert"), mcp.Required()),
		...
		{Tool: mcp.NewTool("prometheus_runtimeinfo",
			mcp.WithDescription("Provide detailed information about the Prometheus server's runtime state to monitor server health and performance through details about garbage collection, memory usage, and other runtime metrics"),
			mcp.WithString("k8surl", mcp.Description("Kubernetes API server URL"), mcp.Required()),
			mcp.WithString("k8stoken", mcp.Description("Kubernetes API server authentication token"), mcp.Required()),
		), Handler: s.prometheusRuntimeInfo},
		{Tool: mcp.NewTool("prometheus_TSDB_status",
			mcp.WithDescription("Provide information about the time series database (TSDB) status in Prometheus to monitor database health through details about data storage, head blocks, WAL status, and other TSDB metrics"),
			mcp.WithString("k8surl", mcp.Description("Kubernetes API server URL"), mcp.Required()),
			mcp.WithString("k8stoken", mcp.Description("Kubernetes API server authentication token"), mcp.Required()),
