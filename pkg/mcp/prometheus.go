...
func (s *Server) initPrometheus() []server.ServerTool {
	return []server.ServerTool{
		{Tool: mcp.NewTool("prometheus_generate_query",
			mcp.WithDescription("Generate a PromQL query from a natural language description to investigate metric-based issues. This tool streamlines metric analysis for rapid incident response and monitoring."),
		...
		{Tool: mcp.NewTool("prometheus_metrics_query",
			mcp.WithDescription("Retrieve current metric values using instant queries to monitor system performance. This tool supports real-time debugging of issues like resource consumption spikes."),
			mcp.WithString("k8surl", mcp.Description("Kubernetes API server URL"), mcp.Required()),
			mcp.WithString("k8stoken", mcp.Description("Kubernetes API server authentication token"), mcp.Required()),
		...
		{Tool: mcp.NewTool("prometheus_metrics_query_range",
			mcp.WithDescription("Retrieve historical metric data using range queries to analyze trends and patterns. This tool supports root cause analysis by examining metric behavior over time."),
			mcp.WithString("k8surl", mcp.Description("Kubernetes API server URL"), mcp.Required()),
			mcp.WithString("k8stoken", mcp.Description("Kubernetes API server authentication token"), mcp.Required()),
			mcp.WithString("query", mcp.Description("Prometheus PromQL expression query string"), mcp.Required()),
		...
		{Tool: mcp.NewTool("prometheus_list_metrics",
			mcp.WithDescription("List all available Prometheus metrics to verify monitoring coverage. This tool ensures comprehensive metric collection for incident analysis and monitoring setup."),
			mcp.WithString("k8surl", mcp.Description("Kubernetes API server URL"), mcp.Required()),
			mcp.WithString("k8stoken", mcp.Description("Kubernetes API server authentication token"), mcp.Required()),
		), Handler: s.prometheusListMetrics},
		{Tool: mcp.NewTool("prometheus_metric_info",
			mcp.WithDescription("Retrieve detailed statistics for a specific Prometheus metric to analyze its behavior. This tool supports debugging by identifying anomalies like unexpected metric peaks."),
			mcp.WithString("k8surl", mcp.Description("Kubernetes API server URL"), mcp.Required()),
			mcp.WithString("k8stoken", mcp.Description("Kubernetes API server authentication token"), mcp.Required()),
		...
		{Tool: mcp.NewTool("prometheus_series_query",
			mcp.WithDescription("Retrieve specific time series by label selectors to isolate metrics for analysis. This tool supports troubleshooting by focusing on relevant data for incident investigation."),
			mcp.WithString("k8surl", mcp.Description("Kubernetes API server URL"), mcp.Required()),
			mcp.WithString("k8stoken", mcp.Description("Kubernetes API server authentication token"), mcp.Required()),
		...
		{Tool: mcp.NewTool("prometheus_targets",
			mcp.WithDescription("List the health of Prometheus scrape targets to verify data collection status. This tool diagnoses issues like downed targets impacting metric availability during troubleshooting."),
			mcp.WithString("k8surl", mcp.Description("Kubernetes API server URL"), mcp.Required()),
			mcp.WithString("k8stoken", mcp.Description("Kubernetes API server authentication token"), mcp.Required()),
		...
		{Tool: mcp.NewTool("prometheus_targets_metadata",
			mcp.WithDescription("Retrieve metadata for metrics from specific Prometheus targets to verify their exposure. This tool supports monitoring setup by ensuring consistent metric labels and units."),
			mcp.WithString("k8surl", mcp.Description("Kubernetes API server URL"), mcp.Required()),
			mcp.WithString("k8stoken", mcp.Description("Kubernetes API server authentication token"), mcp.Required()),
		...
		{Tool: mcp.NewTool("prometheus_list_label_names",
			mcp.WithDescription("List all label names in Prometheus metrics to understand their structure. This tool aids in configuring alerts or queries for effective monitoring and incident analysis."),
			mcp.WithString("k8surl", mcp.Description("Kubernetes API server URL"), mcp.Required()),
			mcp.WithString("k8stoken", mcp.Description("Kubernetes API server authentication token"), mcp.Required()),
		...
		{Tool: mcp.NewTool("prometheus_list_label_values",
			mcp.WithDescription("List values for a specific Prometheus label to identify monitored instances. This tool supports alert configuration and incident analysis by targeting specific metric dimensions."),
			mcp.WithString("k8surl", mcp.Description("Kubernetes API server URL"), mcp.Required()),
			mcp.WithString("k8stoken", mcp.Description("Kubernetes API server authentication token"), mcp.Required()),
		...
		{Tool: mcp.NewTool("prometheus_get_alerts",
			mcp.WithDescription("List all currently firing Prometheus alerts to prioritize ongoing issues. This tool serves as a starting point for real-time incident response and triage."),
			mcp.WithString("k8surl", mcp.Description("Kubernetes API server URL"), mcp.Required()),
			mcp.WithString("k8stoken", mcp.Description("Kubernetes API server authentication token"), mcp.Required()),
		), Handler: s.prometheusGetAlerts},
		{Tool: mcp.NewTool("prometheus_get_rules",
			mcp.WithDescription("Retrieve configured Prometheus alerting and recording rules to verify their setup. This tool supports troubleshooting by identifying misconfigured rules affecting alerting accuracy."),
			mcp.WithString("k8surl", mcp.Description("Kubernetes API server URL"), mcp.Required()),
			mcp.WithString("k8stoken", mcp.Description("Kubernetes API server authentication token"), mcp.Required()),
		...
		{Tool: mcp.NewTool("prometheus_create_alert",
			mcp.WithDescription("Create a new Prometheus alert rule to monitor specific conditions. This tool enhances monitoring by enabling rapid response to critical metric thresholds."),
			mcp.WithString("k8surl", mcp.Description("Kubernetes API server URL"), mcp.Required()),
			mcp.WithString("k8stoken", mcp.Description("Kubernetes API server authentication token"), mcp.Required()),
		...
		{Tool: mcp.NewTool("prometheus_update_alert",
			mcp.WithDescription("Update a Prometheus alert rule to refine its thresholds or conditions. This tool optimizes alerting accuracy to reduce noise during monitoring and incident response."),
			mcp.WithString("k8surl", mcp.Description("Kubernetes API server URL"), mcp.Required()),
			mcp.WithString("k8stoken", mcp.Description("Kubernetes API server authentication token"), mcp.Required()),
		...
		{Tool: mcp.NewTool("prometheus_delete_alert",
			mcp.WithDescription("Delete a Prometheus alert rule to eliminate unnecessary notifications. This tool streamlines monitoring by removing outdated rules during cleanup."),
			mcp.WithString("k8surl", mcp.Description("Kubernetes API server URL"), mcp.Required()),
			mcp.WithString("k8stoken", mcp.Description("Kubernetes API server authentication token"), mcp.Required()),
			mcp.WithString("applabel", mcp.Description("Application label that identifies the PrometheusRule resource, use alertname if applabel is not provided"), mcp.Required()),
			mcp.WithString("namespace", mcp.Description("Kubernetes namespace of the alert"), mcp.Required()),
		...
		{Tool: mcp.NewTool("prometheus_runtimeinfo",
			mcp.WithDescription("Retrieve Prometheus server health and performance metrics to ensure monitoring reliability. This tool supports meta-debugging by diagnosing server issues like resource constraints."),
			mcp.WithString("k8surl", mcp.Description("Kubernetes API server URL"), mcp.Required()),
			mcp.WithString("k8stoken", mcp.Description("Kubernetes API server authentication token"), mcp.Required()),
		), Handler: s.prometheusRuntimeInfo},
		{Tool: mcp.NewTool("prometheus_TSDB_status",
			mcp.WithDescription("Retrieve Prometheus TSDB status to verify data storage and retrieval integrity. This tool supports troubleshooting by ensuring reliable metric availability for monitoring."),
			mcp.WithString("k8surl", mcp.Description("Kubernetes API server URL"), mcp.Required()),
			mcp.WithString("k8stoken", mcp.Description("Kubernetes API server authentication token"), mcp.Required()),
