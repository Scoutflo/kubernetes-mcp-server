			...
			Tool: WithMeta(
				mcp.NewTool("argocd_get_application_workload_logs",
					...
					mcp.WithString("resource_ref",
						mcp.Description(`JSON string with resource reference. Required keys: "name", "namespace", "kind". Optional keys: "group", "version", "container". Example: {"name":"my-pod","namespace":"default","kind":"Deployment","group":"apps","version":"v1"}`),
						mcp.Required(),
					),
					mcp.WithString("tail",
		...
		},
		{
			Tool: WithMeta(
				mcp.NewTool("argocd_get_resource_events",
					...
					mcp.WithString("resource_ref",
						mcp.Description(`JSON string with resource reference. Required keys: "name", "namespace". Optional key: "uid". Example: {"name":"my-pod","namespace":"default"}`),
						mcp.Required(),
					),
					mcp.WithString("start_time", mcp.Description("Start time for event retrieval in RFC3339 format (e.g., '2024-01-01T00:00:00Z') or Unix timestamp. Required if end_time is provided.")),
					mcp.WithString("end_time", mcp.Description("End time for event retrieval in RFC3339 format (e.g., '2024-01-01T23:59:59Z') or Unix timestamp. Required if start_time is provided.")),
		...
		},
		{
			Tool: WithMeta(
				mcp.NewTool("argocd_get_resource_actions",
					...
					mcp.WithString("resource_ref",
						mcp.Description(`JSON string with resource reference. Required keys: "name", "namespace", "kind", "version". Optional key: "group" (empty for core resources). Example: {"name":"my-deploy","namespace":"default","kind":"Deployment","group":"apps","version":"v1"}`),
						mcp.Required(),
					),
				),
				map[string]any{"provider": ProviderArgoCD},
