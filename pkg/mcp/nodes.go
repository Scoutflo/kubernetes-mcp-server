...
func (s *Server) initNodes() []server.ServerTool {
	return []server.ServerTool{
		{Tool: mcp.NewTool("nodes_list",
			mcp.WithDescription("List all cluster nodes with their status and resource information for infra usage and inspection"),
		...
		{Tool: mcp.NewTool("nodes_get",
			mcp.WithDescription("Retrieve detailed node information including conditions and resource capacity for inspection"),
