...
// PromQLPrompt is the system prompt for the PromQL query generator
const PromQLPrompt = `
...
Your response should focus on providing a concise, efficient, and executable PromQL query that addresses the user's requirements. Keep your explanation minimal and focused on the query itself.
